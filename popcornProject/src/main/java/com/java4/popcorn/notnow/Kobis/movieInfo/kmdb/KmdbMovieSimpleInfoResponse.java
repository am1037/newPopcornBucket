package com.java4.popcorn.notnow.Kobis.movieInfo.kmdb;
...
@Data
public class KmdbMovieSimpleInfoResponse {
    @JsonProperty("Query")
    ...
    public static KmdbMovieSimpleInfoResponse readFromJson(String path){
        ObjectMapper om = new ObjectMapper();
        try {
            return om.readValue(new File(path), KmdbMovieSimpleInfoResponse.class);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }
